"""Low-level vector index utilities for the shared RAG index."""
...
class NumpyFlatIPIndex:
    """Small inner-product index used when faiss-cpu is unavailable."""
...
def save_vector_index(index: Any, vectors: np.ndarray, index_path: str | Path) -> str:
    """Save the index and return the actual backend used."""
